...
- After updating any agent-resources/thoughts/ artifact, use the Compaction prompt and write/update the Progress Memo.
...
- If the chat context is getting long, use the Compaction prompt before proceeding.
