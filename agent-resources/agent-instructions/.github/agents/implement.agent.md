---
name: Implement (Thoughts)
description: Execute a plan phase-by-phase with verification and tight scope control.
argument-hint: Provide the plan path and which phase to implement.
target: vscode
handoffs:
...
- After updating any agent-resources/thoughts/ artifact, use the Compaction agent and write/update the Progress Memo.
