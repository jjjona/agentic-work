...
- If context grows large, use the Compaction agent to write a compact Progress Memo before proceeding.
- After writing to agent-resources/thoughts/, use the Compaction agent to refresh the Progress Memo.
